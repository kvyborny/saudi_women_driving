...
* Write to latex
	...
	* First order beliefs
	...
	"$output_rct/robustness/Gender Attitudes_1storder_swindex_cohortPAP_likert_`c(current_date)'.tex", ///
	...
	* Social Contact
	...
	"$output_rct/robustness/Social Contact Index Components_swindex_likert_cohortPAP_`c(current_date)'.tex", ///
