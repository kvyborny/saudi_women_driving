...
month. The outcomes in Columns 5 and 6 were constructed as follows: respondents were asked to rate their own level of
...
* Write to latex
	...
	* Drive training, license and mobility
		esttab $drive_mob ///
		using "$output_rct/robustness/Drive training & license_cohortPAP_`c(current_date)'.tex", ///
		...
		* Economic and financial agency
		esttab $lab using ///
		"$output_rct/robustness/LFP_ind dec_cohortPAP_likert_`c(current_date)'.tex", ///
