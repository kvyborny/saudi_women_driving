...
Purpose: 		ROBUSTNESS TABLE - Test robustness of marital status results to 
							  treatment interactions - robustness to including
...
* Write to latex
	* (1)
	esttab	employed_w3_1 employed_w3_2 using ///
			"$output_rct/robustness/Alt Table A17 - treatmentinteract_cohortPAP_kids_marital dummies_`c(current_date)'.tex", ///
