...
esttab using "$output_descr/travel_desc_control_wave2_panel A.tex" , tex ///
...
esttab using "$output_descr/travel_desc_control_wave2_panel B.tex" , tex ///
...
esttab using "$output_descr/travel_desc_control_wave2_panel C.tex" , tex ///
	cells("count mean(fmt(2)) sd(fmt(2)) min max") replace label nonum frag nogaps ///
	mlabels(none) collabels(none) noobs nolines
